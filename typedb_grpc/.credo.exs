  ...
  configs: [
    %{
      ...
      files: %{
        ...
        # `lib/protocol/` is machine-written by `mix typedb.grpc.gen` from
        # TypeDB's `.proto` files. Style findings there are findings about
        # protoc-gen-elixir, and the only honest fix would be to edit generated
        # code, which the next regeneration would undo.
        excluded: [~r"/_build/", ~r"/deps/", ~r"/node_modules/", ~r"lib/protocol/"]
      },
      #
